...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    prodJs: {
      ...
      files: {
        '.tmp/public/**/*.html': ['.tmp/public/min/slims.min.js'],
        'views/**/*.html': ['.tmp/public/min/slims.min.js'],
        'views/**/*.ejs': ['.tmp/public/min/slims.min.js']
      }
    },
    ...
    prodStyles: {
      ...
      files: {
        '.tmp/public/index.html': ['.tmp/public/min/slims.min.css'],
        'views/**/*.html': ['.tmp/public/min/slims.min.css'],
        'views/**/*.ejs': ['.tmp/public/min/slims.min.css']
      }
    },
    ...
    prodJsJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/min/slims.min.js']
      }
    },
    ...
    prodStylesJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/min/slims.min.css']
      }
    },
